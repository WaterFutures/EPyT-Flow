...
from epyt_flow.data.benchmarks.gecco_water_quality import load_gecco2017_water_quality_data, \
    load_gecco2018_water_quality_data, load_gecco2019_water_quality_data, evaluation_score
...
def test_gecco_water_quality():
    ...
    assert evaluation_score(np.random.choice([0, 1], size=y.shape), y=y) is not None
